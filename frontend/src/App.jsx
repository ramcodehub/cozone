...
function App() {
  ...
  useEffect(() => {
    ...
    AOS.init({ duration: 650, once: true, easing: "ease-in-out" });
    AOS.refresh();
  }, [location]);
  ...
  const updateSEOMetadata = (pathname) => {
    let seoData;
    switch (pathname) {
      case '/': seoData = pageSEOMetadata.home; break;
      case '/about': seoData = pageSEOMetadata.about; break;
      case '/amenities': seoData = pageSEOMetadata.amenities; break;
      case '/plans': seoData = pageSEOMetadata.plans; break;
      case '/gallery': seoData = pageSEOMetadata.gallery; break;
      case '/day-pass': seoData = pageSEOMetadata.dayPass; break;
      case '/private-cabins': seoData = pageSEOMetadata.privateCabins; break;
      case '/dedicated-desk': seoData = pageSEOMetadata.dedicatedDesk; break;
      case '/conference-rooms': seoData = pageSEOMetadata.conferenceRooms; break;
      case '/virtual-zone': seoData = pageSEOMetadata.virtualZone; break;
      case '/custom-built-office': seoData = pageSEOMetadata.customBuiltOffice; break;
      default: seoData = pageSEOMetadata.home;
    }
