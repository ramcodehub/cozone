    ...
    <div className='d-flex flex-column gap-2'>
      ...
      <div className='about aboutt'>
        ...
        <div className="mt-4" data-aos="fade-up">
          ...
          <section className="py-4 values w-100">
            <div className="">
              <div className="row mb-2">
                <div className="col-lg-8" data-aos="fade-up">
                  <h2 className="fw-bold aft">Our Values  </h2>
                  <p className="text-muted fs-5 ps-3">The principles that guide our community and workspace culture.</p>
                </div>
              </div>

              <div className="container row g-4 d-flex  align-items-center justify-content-center" >

                <div className="col-lg-4 col-md-6" data-aos="fade-up">
                  <div className="p-4 h-100 border value-card rounded shadow-sm">
                    <i className="bi bi-shield-check fs-1 mb-3"></i>
                    <h3 className="fw-bold mb-2">Integrity</h3>
                ...
                <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay='200'>
                  <div className="p-4 h-100 border value-card rounded shadow-sm">
                    ...
                    <h3 className="fw-bold mb-2">Collaboration</h3>
                    <p className="text-muted fs-6">
                ...
                <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay='400'>
                  <div className="p-4 h-100 border value-card rounded shadow-sm">
                    ...
                    <h3 className="fw-bold mb-2">Innovation</h3>
                    <p className="text-muted fs-6">
                ...
                <div className="col-lg-4 col-md-6" data-aos="fade-up" >
                  <div className="p-4 h-100 border value-card rounded shadow-sm">
                    ...
                    <h3 className="fw-bold mb-2">Inclusivity</h3>
                    <p className="text-muted fs-6">
                ...
                <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay='200'>
                  <div className="p-4 h-100 border value-card rounded shadow-sm">
                    ...
                    <h3 className="fw-bold mb-2">Excellence</h3>
                    <p className="text-muted fs-6">
      ...
      <ContactCard
        ...
        content="Whether you need a private cabin, a hot desk, or a meeting room, Co-Zone gives you the flexibility to work your way. Grow your business, build your network, and achieve more — all in a space designed for success."
        image={Img}
        action="scroll"
      />
    </div>
